...
public class UserViewModel extends ViewModel implements OnUserInfoUpdateListener {
    ...
    public static List<UserInfo> getUsers(List<String> ids, String groupId,UserInfoCallBack callBack) {
        return ChatManager.Instance().getUserInfos(ids, groupId,callBack);
    }
...
//    }
    ...
    public UserInfo getUserInfo(String userId, boolean refresh, UserInfoCallBack callBack) {
        Log.e("userSource", "UserViewModel.getUserInfo");
        return ChatManager.Instance().getUserInfo(userId, refresh, callBack);
    }
