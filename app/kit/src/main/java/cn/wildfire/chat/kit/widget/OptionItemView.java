...
public class OptionItemView extends LinearLayout {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        contactLinearLayout = view.findViewById(R.id.contactLinearLayout);
    ...
    public void setDividerVisibility(int visibility, int marginTop) {
        this.dividerVisibility = visibility;
        if (dividerView != null) {
            dividerView.setVisibility(visibility);
            LinearLayout.LayoutParams params = (LinearLayout.LayoutParams) dividerView.getLayoutParams();
            params.topMargin = dp2px(marginTop);
    ...
    /**
     * 动态设置布局高度和左侧图片资源的大小
     * @param mRootHeight           根视图的高度
     * @param leftIconWidth         左侧指示图片的大小
     */
    public void setRootLayoutHeight(int mRootHeight, int leftIconWidth) {
        LinearLayout.LayoutParams params = (LinearLayout.LayoutParams) contactLinearLayout.getLayoutParams();
        params.height = dp2px(mRootHeight);
        contactLinearLayout.setLayoutParams(params);

        LinearLayout.LayoutParams leftImgParams = (LinearLayout.LayoutParams) startImageView.getLayoutParams();
        leftImgParams.width = dp2px(leftIconWidth);
        leftImgParams.height = dp2px(leftIconWidth);
        startImageView.setLayoutParams(leftImgParams);
